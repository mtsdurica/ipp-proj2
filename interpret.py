        ...
        match i.get_opcode():
            ...
            case 'WRITE':
                ...
                match symb_type:
                    ...
                    case 'nil':
                        ...
                        pass
            case 'LABEL':
                label_id = args_list[0].get_val()
                label_order = i.get_order()
                labels.update({label_id: label_order})
            case 'JUMP':
                j_label_id = args_list[0].get_val()
                j_order = i.get_order()
                label = find_label(instructions, j_label_id, j_order, labels)
                # setting the main iterator to a new value to correctly jump
            ...
            case 'JUMPIFEQ':
                ...
                if symb1_val == symb2_val:
                    if labels.get(lb_id, 'NotFound') == 'NotFound':
                        found_label = ''
